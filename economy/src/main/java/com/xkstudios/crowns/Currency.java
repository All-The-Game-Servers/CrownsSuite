...
public class Currency {
    ...
    public static void reload(CrownsPlugin plugin) {
        PER_SHILLING = plugin.getConfig().getInt("currency.rates.pennies-per-shilling", 100);
        PER_CROWN = PER_SHILLING * plugin.getConfig().getInt("currency.rates.shillings-per-crown", 100);
    }
