...
This repo is in stabilization mode for a flagship v1 release with official Paper, Fabric, and Bedrock support. Billing and broader platform expansion still remain beyond the current source tree, and Bedrock still needs real multi-machine operator signoff before it should be called production-proven.
