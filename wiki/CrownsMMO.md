...
Use `/cmmo start` to enter the configured dedicated Floor 1 world at First Haven. CrownsTerrain `1.5.3` uses the fresh world `crowns_floor_1_v3`; update the MMO Floor 1 world config to that name when adopting the terrain relaunch.
